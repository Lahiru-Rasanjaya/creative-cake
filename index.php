...
<div class="container-fluid p-0 wow fadeIn" data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/banner1.webp" alt="banner image">
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp">
                <div class="row img-twice position-relative h-100 ">
                    <div class="col-6">
                        <img class="img-fluid rounded fact-item" src="img/about1.jpg" alt="about image 1">
                    </div>
                    <div class="col-6 align-self-end">
                        <img class="img-fluid rounded fact-item" src="img/about2.jpg" alt="about image 2">
                    </div>
                </div>
            </div>
